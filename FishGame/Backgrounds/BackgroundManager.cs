...
namespace FishGame.Backgrounds
{
    internal class BackgroundManager
    {
        ...
        public BackgroundManager(Season season, Location location)
        {
            _season = season;
            _location = location;
        ...
        public void NextSeason()
        {
            ...
            SeasonChanged?.Invoke(this, new SeasonChangedEventArgs(_season));
            ReloadBackground();
        }
    ...
    public class SeasonChangedEventArgs : EventArgs
    {
        ...
        public SeasonChangedEventArgs(Season season) { _season = season; }
